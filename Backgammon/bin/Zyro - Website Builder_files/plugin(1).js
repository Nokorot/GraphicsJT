CKEDITOR.plugins.add( 'wbbgcolor', {
	...
	init: function( editor ) {
		...
		if ( !CKEDITOR.env.hc ) {
			addButton( 'Wbbgcolor', 'fore', lang.textColorTitle, 10 );
		}
...
//					css: CKEDITOR.skin.getPath( 'editor' ),
				...
				onOpen: function() {
					if (!dialog) {
						dialog = true;
						$("#" + editor.ui.instances.Wbbgcolor._.id).ColorPicker({
							eventName: "wbClick",
							color: "#ffffff",
							trans: false,
							auto: true,
							onShow: function (colpkr) {
								$(colpkr).fadeIn(150, function() {
									editor.ui.instances.Wbbgcolor.setState(1);
								});
								return false;
							},
							...
							onSubmit: function(hsb, color, rgb, el) {
								if ( color ) {
									color = '#' + color;
									var colorStyle = config[ 'colorButton_' + 'back' + 'Style' ];
...
//								$(this).ColorPickerSetColor(col);
					...
					if (hiding) {
//						$("#" + editor.ui.instances.Wbbgcolor._.id).removeClass("cke_button_on").addClass("cke_button_off");
//						editor.ui.instances.Wbbgcolor._.on = 0;
//						editor.ui.instances.Wbbgcolor.setState(2);
						if (editor.ui.instances.Wbbgcolor._.on == 1) {
							editor.ui.instances.Wbbgcolor.click();
						}
						hiding = false;
					} 
					else if (editor.ui.instances.Wbbgcolor._.on == 1) {
						$("#" + editor.ui.instances.Wbbgcolor._.id).trigger("wbClick");
						
						editor.ui.instances.Wbbgcolor.setState(1);
//						$("#" + editor.ui.instances.Wbbgcolor._.id).removeClass("cke_button_off").addClass("cke_button_on");
					}
					/*
